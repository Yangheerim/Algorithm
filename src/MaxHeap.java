...
public class MaxHeap {
    ...
    public static void insert(int data) {
        ...
        // 새로 들어온 값이 루트가 되거나, 부모>자식이 모두 만족할때까지 반복
    ...
    public static int delete() {
        ...
        while (position * 2 < heap.size()) { //???
            ...
            // left node의 값과 right node의 값 중 더 큰값과 swap하기 때문에 비교해봄
            ...
            if (heap.get(position) < heap.get(small_position)) { // 부모 값이 더 작으면 바꿔줘야함.
                int tmp = heap.get(position);
